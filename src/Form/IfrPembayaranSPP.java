 ...
 * @author user
 */
public class IfrPembayaranSPP extends javax.swing.JInternalFrame {
    ...
    private String[]label1={"ID SPP Detail","ID SPP","NIS","Harga","Bulan","Tahun"};

    String vtahun;
    
    public IfrPembayaranSPP(String id) {
        initComponents();
    ...
    public void transk(){
        try {
            s=c.createStatement();
            String sql="SELECT id_transspp FROM tb_transspp ORDER BY id_transspp DESC";
            r = s.executeQuery(sql);
            if(r.next()){
            String id = r.getString("id_transspp");
          int nomor= Integer.valueOf(id.substring(5,8));
                if(nomor<9){
                jLabel2.setText("SPP-000"+String.valueOf(nomor+1));
                }else if(nomor<99){
                jLabel2.setText("SPP-00"+String.valueOf(nomor+1));
                }else if(nomor<999){
                jLabel2.setText("SPP-0"+String.valueOf(nomor+1));
                }else{
                jLabel2.setText("SPP-"+String.valueOf(nomor+1));
                }
            }
            else{
                jLabel2.setText("SPP-0001");
            }
        } catch (Exception e) {
        }
    }
    ...
    public void setBulan(){
        try {
            s=c.createStatement();
            String sql="SELECT bulan FROM tb_transsppdet a, tb_transspp b "
                    + "where a.id_transspp=b.id_transspp and b.nis='"+jtNIS.getText()+"' "
                    + "ORDER BY a.id_transsppdet DESC ";
            r = s.executeQuery(sql);
            if(r.next()){
     ...
     public void pencarian(){
       ...
       {
           s=c.createStatement();
           String sql = "SELECT s.id_transspp, s.nis, n.nm_siswa, s.tanggal, s.jumlahbln, "
                   + "s.totalbayar FROM tb_transspp AS s, tb_siswa AS n "
                   + "WHERE s.nis=n.nis AND s.nis LIKE '"+jtNIS.getText()+"'"
                   + "AND s.nis=n.NIS ORDER BY s.id_transspp DESC";
           ...
           while(r.next())
           {
               dataSPP[x][0]=r.getString("id_transspp");
    ...
    public void pencarian1(){
       ...
       {
           s=c.createStatement();
           String sql = "SELECT a.id_transsppdet, a.id_transspp,b.nis, a.harga, a.bulan ,a.tahun"
                   + " FROM tb_transsppdet a,tb_transspp b  "
                   + "WHERE a.id_transspp=b.id_transspp AND b.nis='"+jtNIS.getText()+"'"
                   + " ORDER BY a.id_transsppdet desc";
           ...
           while(r.next())
           {
               dataSPP1[x][0]=r.getString("id_transsppdet");
               dataSPP1[x][1]=r.getString("id_transspp");
       ...
       private void simpantrs()
    {
        ...
        try 
       {
           String sql = "INSERT INTO tb_transspp VALUES('"+jLabel2.getText()+"','"+jtNIS.getText()+"','"+tampil+"',0,0,'"+txtId.getText()+"')";
           s.executeUpdate(sql);
           s.close();
       ...
       private void updatetrs(){
        try 
       {
           String sql = "UPDATE tb_transspp SET totalbayar='"+jttot.getText()+"', jumlahbln='"+jljumlah.getText()+"' WHERE id_transspp='"+jLabel2.getText()+"'";
           s.executeUpdate(sql);
       }
       catch (SQLException e) 
       {
       ...
       private void simpantghn()
    {
        try 
       {
           String sql = "INSERT INTO tb_transsppdet VALUES(null,'"+jLabel2.getText()+"',"
       ...
       private void setnilai(){
        try {
            String abg = "select * from tb_gol_spp where nama_gol_spp ='"+txtGol.getText()+"'";
            s =c.createStatement();
            r = s.executeQuery(abg);
            r.next();
            String nilai = String.valueOf(r.getInt("nominal_spp"));
       ...
       public void JumlahBulan(){
        try {
            String abg = "SELECT COUNT(harga) AS total FROM tb_transsppdet WHERE id_transspp ='"+jLabel2.getText()+"'";
            s =c.createStatement();
            r = s.executeQuery(abg);
            r.next();
        ...
        try {
            String abg = "SELECT SUM(harga) AS total FROM tb_transsppdet WHERE id_transspp ='"+jLabel2.getText()+"'";
            s =c.createStatement();
            r = s.executeQuery(abg);
            r.next();
            String nilai = String.valueOf(r.getInt("total"));
    ...
    private void initComponents() {
        ...
        jLabel99.setText("Form Pembayaran SPP");

        jLabel3.setText("Form ini digunakan untuk mengolah data pembayaran SPP");
        ...
        jtbspp1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "ID DPP Detail", "ID SPP", "Nis", "Harga", "Bulan", "Tahun"
            }
        ));
                    ...
                    .addGroup(jPanel6Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            .addGroup(jPanel6Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel6Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(lbBulan, javax.swing.GroupLayout.PREFERRED_SIZE, 151, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        jPanel1.add(txtHasil, new org.netbeans.lib.awtextra.AbsoluteConstraints(590, 570, 25, -1));
        ...
        jPanel1.add(txtHasil2, new org.netbeans.lib.awtextra.AbsoluteConstraints(620, 570, 28, -1));
        ...
        txtThCoba.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                txtThCobaActionPerformed(evt);
            }
        });
        jPanel1.add(txtThCoba, new org.netbeans.lib.awtextra.AbsoluteConstraints(660, 570, 26, -1));
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        cSiswa cs = new cSiswa(txtId.getText());
      ...
      batasPembayaran();
       ...
       // if("Juli".equals(lbBulan.getText())){
         //  JOptionPane.showMessageDialog(null,"Bulan masih kosong !");
            ...
            try {
            s=c.createStatement();
            String sql="SELECT * FROM tb_transspp a inner join tb_transsppdet b on a.id_transspp =b.id_transspp where a.nis='"+jtNIS.getText()+"' "
                    + " and b.bulan='"+lbBulan.getText()+"' and b.tahun='"+txtTahun.getText()+"' ";
            r = s.executeQuery(sql);
            if(r.first()){
            JOptionPane.showMessageDialog(this, "Pembayaran SPP dengan nis "+jtNIS.getText()+" bulan"
    ...
    private void txtThCobaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_txtThCobaActionPerformed
        // TODO add your handling code here:
    }//GEN-LAST:event_txtThCobaActionPerformed
