...
public class cSiswa1 extends javax.swing.JInternalFrame {
    ...
    private String[]label={"Nis","Nama Siswa","Kelas","Nama Golongan"};
    IfrPembayaranSPI sp;
    public cSiswa1(String id) {
        initComponents();
        bukakoneksi();
        bacaTable();
        
        sp = new IfrPembayaranSPI(id);
    ...
    public void bacaTable(){
       ...
       {
           s=c.createStatement();
           String sql = "SELECT s.nis, s.nm_siswa, k.nama_kelas, g.nama_gol_spi FROM tb_siswa AS s, "
                   + "tb_kelas AS k,tb_gol_spi AS g WHERE s.id_kelas = k.id_kelas and s.id_gol_spi=g.id_gol_spi";
           ...
           while(r.next())
           {
               ...
               datasiswa[x][3]=r.getString("nama_gol_spi");
               x++;
           }
    ...
    public void Pencarian(){
        try 
       {
           ...
           String sql = "SELECT s.nis, s.nm_siswa, k.nama_kelas, g.nama_gol_spi FROM tb_siswa AS s,"
                   + " tb_kelas AS k,tb_gol_spi AS g WHERE s.id_kelas = k.id_kelas and s.id_gol_spi=g.id_gol_spi"
                    + " and s.nm_siswa LIKE '%"+jtNis.getText()+"%' or s.nis LIKE '%"+jtNis.getText()+"%' and s.id_kelas = k.id_kelas and s.id_gol_spi=g.id_gol_spi";
           r=s.executeQuery(sql);
           ResultSetMetaData m=r.getMetaData();
           int kolom=m.getColumnCount();
           int baris=0;
