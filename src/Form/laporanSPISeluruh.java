 ...
 * @author Aries
 */
public class laporanSPISeluruh extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if("".equals(Mulai) || "".equals(Selesai)){
            ...
            String filename = path+"LaporanSPISeluruh.jrxml";
            String filename1 = path+"LaporanSPISeluruhBelum.jrxml";
