...
public class cSiswa extends javax.swing.JInternalFrame {
    ...
    IfrPembayaranSPP sp ;
    public cSiswa(String id) {
        initComponents();
        bukakoneksi();
        bacaTable();
         sp = new IfrPembayaranSPP(id);
    }
    ...
    public void bacaTable(){
       ...
       {
           s=c.createStatement();
           String sql = "SELECT s.nis, s.nm_siswa, k.nama_kelas, g.nama_gol_spp FROM tb_siswa AS s, "
                   + "tb_kelas AS k,tb_gol_spp AS g WHERE s.id_kelas = k.id_kelas and s.id_gol_spp=g.id_gol_spp";
           ...
           while(r.next())
           {
               ...
               datasiswa[x][3]=r.getString("nama_gol_spp");
               x++;
           }
    ...
    public void Pencarian(){
        try 
       {
           ...
           String sql = "SELECT s.nis, s.nm_siswa, k.nama_kelas, g.nama_gol_spp FROM tb_siswa AS s,"
                   + " tb_kelas AS k,tb_gol_spp AS g WHERE s.id_kelas = k.id_kelas and s.id_gol_spp=g.id_gol_spp"
                    + " and s.nm_siswa LIKE '%"+jtNis.getText()+"%' or s.nis LIKE '%"+jtNis.getText()+"%' and s.id_kelas = k.id_kelas and s.id_gol_spp=g.id_gol_spp";
           r=s.executeQuery(sql);
           ResultSetMetaData m=r.getMetaData();
           int kolom=m.getColumnCount();
           int baris=0;
