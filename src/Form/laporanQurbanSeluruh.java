 ...
 * @author Aries
 */
public class laporanQurbanSeluruh extends javax.swing.JInternalFrame {
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        if("".equals(Mulai) || "".equals(Selesai)){
            ...
            String filename = path+"LaporanQurbanSeluruh.jrxml";
            String filename1 = path+"LaporanQurbanSeluruhBelum.jrxml";
            JasperReport jasrep;
            JasperPrint japri;
