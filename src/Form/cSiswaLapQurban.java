 ...
 * @author AriesUX
 */
public class cSiswaLapQurban extends javax.swing.JInternalFrame {
    ...
    laporanQurban sp = new laporanQurban();
    public cSiswaLapQurban() {
        initComponents();
        bukakoneksi();
        bacaTable();
    }
    ...
    public void bacaTable(){
       ...
       {
           s=c.createStatement();
           String sql = "SELECT s.nis, s.nm_siswa, k.nama_kelas FROM tb_siswa AS s, "
                   + "tb_kelas AS k WHERE s.id_kelas = k.id_kelas ";
    ...
    public void Pencarian(){
        try 
       {
           ...
           String sql = "SELECT s.nis, s.nm_siswa, k.nama_kelas FROM tb_siswa AS s,"
                   + " tb_kelas AS k WHERE s.id_kelas = k.id_kelas "
                    + " and s.nm_siswa LIKE '%"+jtNis.getText()+"%' or s.nis LIKE '%"+jtNis.getText()+"%' and s.id_kelas = k.id_kelas ";
           r=s.executeQuery(sql);
           ResultSetMetaData m=r.getMetaData();
           int kolom=m.getColumnCount();
           int baris=0;
