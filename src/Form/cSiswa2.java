 ...
 * @author AriesUX
 */
public class cSiswa2 extends javax.swing.JInternalFrame {
    ...
    private String[]label={"Nis","Nama Siswa","Kelas","ID Golongan"};
    IfrPembayaranQurban sp;
    public cSiswa2(String id) {
        initComponents();
        bukakoneksi();
        bacaTable();
         sp = new IfrPembayaranQurban(id);
    }
    ...
    private void settable()
       ...
       sp.GETextField3().setText((String)jtbsiswa.getValueAt(row, 3));
    ...
    public void bacaTable(){
       ...
       {
           s=c.createStatement();
           String sql = "SELECT s.nis, s.nm_siswa, k.nama_kelas, g.id_gol_qurban FROM tb_siswa AS s, "
                   + "tb_kelas AS k,tb_gol_qurban AS g WHERE s.id_kelas = k.id_kelas and s.id_gol_qurban=g.id_gol_qurban";
           ...
           while(r.next())
           {
               ...
               datasiswa[x][1]=r.getString("nm_siswa");
               datasiswa[x][2]=r.getString("nama_kelas");
               datasiswa[x][3]=r.getString("id_gol_qurban");
               x++;
           }
    ...
    public void Pencarian(){
        try 
       {
           ...
           String sql = "SELECT s.nis, s.nm_siswa, k.nama_kelas, g.id_gol_qurban FROM tb_siswa AS s,"
                   + " tb_kelas AS k,tb_gol_qurban AS g WHERE s.id_kelas = k.id_kelas and s.id_gol_qurban=g.id_gol_qurban"
                    + " and s.nm_siswa LIKE '%"+jtNis.getText()+"%' or s.nis LIKE '%"+jtNis.getText()+"%' and s.id_kelas = k.id_kelas and s.id_gol_qurban=g.id_gol_qurban";
           r=s.executeQuery(sql);
           ResultSetMetaData m=r.getMetaData();
           int kolom=m.getColumnCount();
           int baris=0;
